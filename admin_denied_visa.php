...
<html>
	...
	<body>
		...
		<h2>Denied VISA</h2>
		<h3 class='set_nice_size'><center><u>Denied VISA</u></center></h3>
                ...
                <div class="col-lg-12">
                    <!-- Advanced Tables -->
                                <table border="2" width="100%">
                                    ...
                                    $sql = "SELECT * FROM users WHERE sts = '2' ORDER BY id DESC";
                                    ...
                                    while($row = mysqli_fetch_array($query)){
                                      ...
                                      <tr class="odd gradeX">
                                            ...
                                            <td>
                                            <a onclick="return confirm('Are You Sure You want to Delete This user');" href="admin_delete_user_deneid.php?stu=<?php echo $row['id']; ?>"><button class="btn btn-primary" style="background-color: red; color: aliceblue;"><i class="fa fa-trash-o"></i> Delete</button></a>
